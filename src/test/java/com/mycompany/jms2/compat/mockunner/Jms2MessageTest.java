package com.mycompany.jms2.compat.mockunner;

import com.mockrunner.mock.jms.MockBytesMessage;
import com.mockrunner.mock.jms.MockMessage;
import com.mockrunner.mock.jms.MockQueue;
import com.mockrunner.mock.jms.MockTextMessage;
import com.mycompany.jms2.compat.Jms2BytesMessage;
import com.mycompany.jms2.compat.Jms2Message;
import static com.mycompany.jms2.compat.Jms2Message.JMS_DELIVERY_TIME;
...
public class Jms2MessageTest {
    ...
    /**
     *
     * JMSDeliveryTime was introduced with jms2 stored as long property on
     * original message.
     *
     * @throws Exception
     */
    ...
    public void setGetJMSDeliveryTime() throws Exception {
        ...
        assertEquals(deliveryTime, mockMessage.getLongProperty(JMS_DELIVERY_TIME));
    }
    ...
    public void getBytesBody() throws Exception {
        ...
        Jms2Message msg = new Jms2BytesMessage(bytesMessage);
