...
public class Jms2MessageTest {
    ...
    @Test
    public void testGetJMSDeliveryTime() throws Exception {
        jms2Message.getJMSDeliveryTime();
        verify(mockMessage, times(1)).getLongProperty(Jms2Message.JMS_DELIVERY_TIME);
 
    }

    @Test
    public void testSetJMSDeliveryTime() throws Exception {
    }
