...
public class Jms2Message implements Message {
    ...
    public static final  String JMS_DELIVERY_TIME = "JMS2CompatDeliveryTime";
    ...
    public long getJMSDeliveryTime() throws JMSException {
        return delegate.getLongProperty(JMS_DELIVERY_TIME);
    }

    @Override
    public void setJMSDeliveryTime(long deliveryTime) throws JMSException {
        delegate.setLongProperty(JMS_DELIVERY_TIME, deliveryTime);
    }
    ...
    public void clearProperties() throws JMSException {
        //TODO: Store Headers elsewhere
        Long deliveryTime = getJMSDeliveryTime();
        if(delegate.propertyExists(JMS_DELIVERY_TIME))  {
            deliveryTime = getJMSDeliveryTime();
        }
        
        delegate.clearProperties();
        //JMS headers are not included
